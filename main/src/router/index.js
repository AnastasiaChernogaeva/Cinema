...
const AdditionalServices = () =>
  import("../tabs/Admin_Portal/components/AdditionalServices");
...
const ForgottenPassword = () =>
  import("../tabs/Clients_Interface/pages/ForgottenPassword");
  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () =>
            import(
              "../tabs/Admin_Portal/components/InsideTemplatesForID/FilmsTemplate"
            ),
          name: "film",
          meta: {
            layout: "main-admin",
        ...
        },
        {
          ...
          component: () =>
            import(
              "../tabs/Admin_Portal/components/InsideTemplatesForID/ServicesTemplate"
            ),
          name: "service",
          meta: {
            layout: "main-admin",
        ...
        },
        {
          ...
          component: () =>
            import(
              "../tabs/Admin_Portal/components/InsideTemplatesForID/SessionsTemplate"
            ),
          name: "session",
          meta: {
            layout: "main-admin",
        ...
        },
        {
          ...
          component: () =>
            import(
              "../tabs/Admin_Portal/components/InsideTemplatesForID/CinemasTemplate"
            ),
          name: "cinema",
          meta: {
            layout: "main-admin",
        ...
        },
        {
          ...
          component: () =>
            import(
              "../tabs/Admin_Portal/components/InsideTemplatesForID/OrdersTemplate"
            ),
          name: "order",
          meta: {
            layout: "main-admin",
...

    {
      ...
      children: [
        { path: "main", component: Main, alias: "" },
        {
          path: "uorders",
          component: () =>
            import("../tabs/Clients_Interface/components/UserOrders.vue"),
          meta: {
            authClient: true,
          },
        },
        { path: "loginUser", component: LoginUser },
        { path: "signupUser", component: SignupUser },
        {
        ...
        },
        {
          ...
          component: () =>
            import(
              "../tabs/Clients_Interface/components/Inside/MovieInside.vue"
            ),
          name: "cfilm",
          meta: {
            authAdmin: false,
        ...
        },
        {
          ...
          component: () =>
            import(
              "../tabs/Clients_Interface/components/Inside/SessionInside.vue"
            ),
          name: "csession",
          meta: {
            authAdmin: false,
        ...
        },
        {
          ...
          component: () =>
            import(
              "../tabs/Clients_Interface/components/Inside/CinemaInside.vue"
            ),
          name: "ccinema",
          meta: {
            authAdmin: false,
